<?php
    ...
    $sql = "SELECT * FROM products ORDER BY `pimg` DESC";
...
<html>
    ...
    <body>
        ...
        <div id="all">
        <p id="logo"><a href="main1.php"><img src="img/logo.jpg" height="100"></a></p>
        ...
        <div id="animation">
            <div class="coverflow">
                <a href="#"><img src="img/5.jpg" height="300" width="800"></a>
                <a href="#"><img src="img/6.jpg" height="300" width="800"></a>
                <a href="#"><img src="img/7.jpg" height="300" width="800"></a>
                <a href="#"><img src="img/8.jpg" height="300" width="800"></a>
            </div>
        </div>
